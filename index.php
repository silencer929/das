<?php include('header.php'); ?>
	...
	<div class="row d-flex">
		<div class="col"><img class="img-fluid"  src="img/hos_pic1.jpg" alt=""></div>
		<div class="col"><img class="img-fluid"  src="img/hos_pic2.jpg" alt=""></div>
		<div class="col"><img class="img-fluid"  src="img/hos_pic3.jpg" alt=""></div>
	</div>
	<!-- nivo slider ends -->
